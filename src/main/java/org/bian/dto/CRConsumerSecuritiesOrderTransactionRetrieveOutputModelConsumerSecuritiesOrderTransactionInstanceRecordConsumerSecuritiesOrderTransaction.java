...
import org.bian.dto.CRConsumerSecuritiesOrderTransactionInitiateInputModelConsumerSecuritiesOrderTransactionInstanceRecordConsumerSecuritiesOrderTransactionDateType;

import javax.validation.Valid;
  
/**
 * CRConsumerSecuritiesOrderTransactionRetrieveOutputModelConsumerSecuritiesOrderTransactionInstanceRecordConsumerSecuritiesOrderTransaction
 */
public class CRConsumerSecuritiesOrderTransactionRetrieveOutputModelConsumerSecuritiesOrderTransactionInstanceRecordConsumerSecuritiesOrderTransaction   {
  ...
  private CRConsumerSecuritiesOrderTransactionInitiateInputModelConsumerSecuritiesOrderTransactionInstanceRecordConsumerSecuritiesOrderTransactionDateType dateType = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The type of market order underlying the consumer securities order request (e.g. Day Order. Order on Open/Close, Fill or Kill, Limit Order - if allowed for consumer trading) 
  ...
  **/
  ...
  public CRConsumerSecuritiesOrderTransactionInitiateInputModelConsumerSecuritiesOrderTransactionInstanceRecordConsumerSecuritiesOrderTransactionDateType getDateType() {
    return dateType;
  }

  public void setDateType(CRConsumerSecuritiesOrderTransactionInitiateInputModelConsumerSecuritiesOrderTransactionInstanceRecordConsumerSecuritiesOrderTransactionDateType dateType) {
